...
Регистрация, вход, главная страница, личный кабинет, список моих книг, запросы, забронированные книги, карточка пользователя 
...
SCSS, Javascript, React, Node.JS express
